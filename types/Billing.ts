...
import { DataIngestorAggregator } from './DataIngestorAggregator'
import { IASyncFunction } from './Functions'
...
/**
 * Encapsulates the list of properties for a Billing construct.
 */
export interface Billing {
  ...
  /**
   * The DataIngestorAggregator responsible for accepting and aggregating
   * the raw billing data.
   */
  ingestor?: DataIngestorAggregator
